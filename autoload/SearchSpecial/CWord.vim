" SearchSpecialCWord.vim: Generic functions for the matches of the current word
" or other text entities. 
"
" DEPENDENCIES:
"
...
"	001	12-Jul-2009	file creation

function! SearchSpecialCWord#GetStartPosition( pattern )
"*******************************************************************************
"* PURPOSE:
...
"*******************************************************************************
    ...
    let l:start = 0
    while l:start >= 0 && l:start < strlen(l:line) && l:start < col('.')
